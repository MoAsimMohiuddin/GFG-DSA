digit_names = {
    0: "zer", 1: "one", 2: "two", 3: "thr", 4: "fou", 5: "fiv",
    6: "six", 7: "sev", 8: "eig", 9: "nin"
}
...
        # Calculate "add value" and "e_value"
...
        # Build S2
        s2 = "@"
        if e_value & 1 == 1:  # power is odd, so only odd positions
...
# Generate CAPTCHAs for each case
for _ in range(t):
